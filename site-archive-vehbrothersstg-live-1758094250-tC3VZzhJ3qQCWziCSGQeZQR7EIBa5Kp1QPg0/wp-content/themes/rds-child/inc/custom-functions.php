...
function cta_shortcode_shortcode($attr)
{
	...
	if (
		...
		echo '<span  class="max_w_730 d-block no_hover_underline mb-4"><div class="got-an-emergency py-sm-2 py-3 px-sm-4 px-4 text-start rounded-10" >
			...
			$title_class .
			' d-block true_white mb-0 no_hover_underline text_25 line_height_41 font_alt_1 text_bold ps-lg-3 sm_text_24 sm_line_height_29">' .
			$heading .
			'</span> 
			...
			$counteyCode .
			$telLink .
			'"><span class="a-alt d-block mb-0 no_hover_underline text_30 line_height_41 sm_text_36 sm_line_height_45 font_alt_1 ps-lg-3 pb-0">' .
			$telLink .
			'</span></a></div>
                <div class=" ' .
			$button_class .
			...
			'" target="' .
			$target .
			'"><div class="text_25 line_height_30 font_alt_1  d-block text_bold no_hover_underline pe-lg-3  true_white sm_text_24 sm_line_height_29 text-capitalize">' .
			$buttonText .
...
function get_exist_image_url($image_folder, $image_name) {
    ...
    $image_name = preg_replace('/\.[^.]+$/', '', $image_name); // Strip the extension if it exists
