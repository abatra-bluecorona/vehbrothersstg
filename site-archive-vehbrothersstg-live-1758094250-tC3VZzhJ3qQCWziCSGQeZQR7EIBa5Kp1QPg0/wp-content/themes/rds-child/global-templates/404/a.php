            ...
            <div class="col-lg-12 col-xl-12 mx-auto">
                <div class="py-4 5 text-center bg-secondary-alt rounded-9">
                    ...
                    <form role="search" method="get" id="searchform" action="<?php echo esc_url(home_url("/")); ?>" class="input-group search d-inline-flex align-items-center error-search-box">
                        ...
                        <input type="text" value="<?php echo esc_attr(get_search_query()); ?>" name="s" id="s" class="form-control rounded-0 empty-search error-search  bc_text_semibold border-0  h-56" placeholder="SEARCH" style="font-family: Open Sans !important; font-weight: 600 !important;">
                    </form>
                </div>
            </div>
        </div>
