        ...
        <div class="row">
            <div class="col-lg-5">
                <?php if (!empty($args["page_templates"]["finance_page"]["heading"])): ?>
                    <h1 class="text-unset"><?php echo $args["page_templates"]["finance_page"]["heading"]; ?></h1>
                <?php endif; ?>
                ...
                <?php if (!empty($args["page_templates"]["finance_page"]["button_text"])): ?>
                    <a target="<?php echo $args["page_templates"]["finance_page"]["target"] == "true" ? "_blank" : "_self"; ?>" href="<?php echo get_home_url() . $args["page_templates"]["finance_page"]["button_link"]; ?>" class="btn btn-primary"><?php echo $args["page_templates"]["finance_page"]["button_text"]; ?> <i class="icon-chevron-right1 ms-2"></i></a>
                <?php endif; ?>
            </div>
