    ...
    <div class="container-fluid py-5 py-lg-5 text-center ">
        <div class="container pb-lg-3 pt-lg-4 py-2">
            <div class="row align-items-center justify-content-center position-relative">
                ...
                <div class="swiper-button-next affiliation_next_a d-lg-none">
                    <i class="icon-chevron-right text_20 line_height_25 transform_lg true_black"></i>
                </div>
                <div class="swiper-button-prev affiliation_prev_a d-lg-none">
                    <i class="icon-chevron-left text_20 line_height_25 transform_lg true_black"></i>
                </div> 
            </div>
