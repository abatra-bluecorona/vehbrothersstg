        ...
        <div class="container">
            <div class="row position-relative">
                <div class="col-lg-10 mx-auto">
                            ...
                            while ($Count >= $i) {
                                ...
                                <div class="swiper-slide">
                                    <div class="text-center">
                                        <img src="<?php echo $logo; ?>" class="img-fluid" width="209" height="118" alt="financing-affiliate-logo" srcset="<?php echo $logo; ?> 1x, <?php echo $logo2x; ?> 2x, <?php echo $logo3x; ?> 3x," />
                                    </div>
                                </div>
                                <?php $i++;
                            }
                    ...
                    <div class="swiper-button-next finance_next_a d-none">
                        <i class="icon-chevron-right text_20 line_height_25  transform_lg  color_primary"></i>
                    </div>
                    <div class="swiper-button-prev finance_prev_a d-none">
