<div class="row">
    <?php if (have_posts()): ?>
        <?php while (have_posts()): the_post(); ?>
            <div class="col-lg-4 col-md-6 mb-4 pb-2 pt-4 px_2">
                    ...
                    <a href="<?php echo esc_url(get_permalink()); ?>" class="no_hover_underline no-underline">
                        ...
                        <div class="card-body px-0 py-0">
                            ...
                            <span class="no_hover_underline w-100 d-inline-flex align-items-center   mb-3 position-absolute lessthenfour blog_read_more_text_color" style="bottom: -40px;">
                                <span class="continue blog_read_more_text_color text-uppercase">Keep Reading <i class="bc_text_18 bc_line_height_18 icon-chevron-right2 ms-1 position-relative"></i></span>
                            </span>
                        </div>
                    </a>
                </div>
