        ...
        <div class="container pt-lg-4 pb-lg-5 pt-2">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h5 data-dark-color="color_primary" data-light-color="true_white" class="apply-conditional-color text-center mb-0 sm_text_22 sm_line_height_27 true_white">
                    <?php echo !empty( $args['globals']['discover_the_difference']['heading']) ?  $args['globals']['discover_the_difference']['heading'] : ''; ?>
                    </h5>


                    <h4 data-dark-color="color_primary" data-light-color="true_white" class="apply-conditional-color text-center h4-alt pb-lg-5 mb-lg-5 pb-4 text-capitalize">
                        <?php echo !empty($args['globals']['discover_the_difference']['subheading']) ? $args['globals']['discover_the_difference']['subheading'] : ''; ?>    
                    </h4>
                </div>
                <div data-dark-color="color_primary" data-light-color="true_white"  class="apply-conditional-color d-lg-block d-none col-lg-12 swiper expect-swiper-a mw-md-292 mx-lg-0 mx-auto swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden">
                    ...
                    foreach ($discoverItems as $value) {
                        echo'<div class="swiper-slide col-lg-4 h-lg-auto pb-lg-5 mb-lg-4 pe-lg-5 swiper-slide-active" role="group" aria-label="'.$i.' / '.$discoverItemsCount.'" style="width: 190px;">
                            ...
                            <div class="row align-items-center align-items-lg-start">
                                ...
                                <div class="col-7 col-lg-10 ps-lg-3 ps-4 border-lg-left" style="border-color: #ffffff !important;">
                                    <h6 class="px-lg-1 mb-0 h6-alt">'.$value['title'].'</h6>
                                </div>
                            </div>
                            <div class="row">
