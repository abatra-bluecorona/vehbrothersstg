...
if (!empty($args["page_templates"]["career_page"]["position"]["wp_job_board"]) && $args["page_templates"]["career_page"]["position"]["wp_job_board"] == true) { ?>
    <div class="container-fluid pt-5" id="open_position">
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="text-center"><a href="https://heartlandhomeservices.wd5.myworkdayjobs.com/VerneEllsworthHann" target="_blank" class="btn btn-primary mw-248">View open positions</a></div>
                </div>
            </div>
        </div>
    </div>
<?php } else { 
    ...
    ?>
    <div class="container-fluid mt-5 mt-lg-2" id="open_position">
