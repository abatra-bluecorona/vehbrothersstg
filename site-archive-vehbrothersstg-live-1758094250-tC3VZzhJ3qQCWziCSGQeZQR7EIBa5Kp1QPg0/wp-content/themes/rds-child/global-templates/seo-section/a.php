...
?>
<div class="d-block">
    <div class="container-fluid pt-5 pt-lg-5 text-center">
            ...
            <div class="row align-items-center py-lg-2">
                <div class="col-lg-12 px-0 bc_homepage text-center">
                    ...
                    <?php if (!empty($args["page_templates"]["history_page"]["seo_section"]["subheading"])): ?>
                        <h2><?php echo $args["page_templates"]["history_page"]["seo_section"]["subheading"]; ?></h2>
                    <?php endif; ?>
            ...
            <div class="row align-items-center py-lg-2">
                <div class="col-lg-12 px-0 bc_homepage text-center">
                    ...
                    <?php if (!empty($args["page_templates"]["homepage"]["seo_section"]["subheading"])): ?>
                        <h2><?php echo $args["page_templates"]["homepage"]["seo_section"]["subheading"]; ?></h2>
                    <?php endif; ?>
            ...
            <div class="row align-items-center py-lg-2">
                <div class="col-lg-12 px-0 bc_homepage text-center">
                    ...
                    <?php if (!empty($args["page_templates"]["about_us_page"]["seo_section"]["subheading"])): ?>
                        <h2><?php echo $args["page_templates"]["about_us_page"]["seo_section"]["subheading"]; ?></h2>
                    <?php endif; ?>
            ...
            <div class="row align-items-center py-lg-2">
                <div class="col-lg-12 px-0 bc_homepage text-center">
                    ...
                    <?php if (!empty($args["page_templates"]["landing_page"]["seo_section"]["subheading"])): ?>
                        <h2><?php echo $args["page_templates"]["landing_page"]["seo_section"]["subheading"]; ?></h2>
                    <?php endif; ?>
