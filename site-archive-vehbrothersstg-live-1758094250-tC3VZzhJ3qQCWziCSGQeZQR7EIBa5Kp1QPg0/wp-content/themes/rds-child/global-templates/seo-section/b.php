    ...
    <div class="container-fluid pt-5 pt-lg-5">
        <div class="container pt-lg-5 py-2 bc_homepage">
            <div class="row py-lg-2">
                <div class="col-lg-12 px-0 bc_homepage seosection-bc">
                    <?php
                    ...
                    ?>
                    <h1><?php echo !empty($args["page_templates"]["history_page"]["seo_section"]["heading"]) ? $args["page_templates"]["history_page"]["seo_section"]["heading"] : ''; ?></h1>
                    <h2 class="pb-lg-5"><?php echo !empty($args["page_templates"]["history_page"]["seo_section"]["subheading"]) ? $args["page_templates"]["history_page"]["seo_section"]["subheading"] : ''; ?></h2>
        ...
        <div class="container pt-lg-5 py-2 bc_homepage">
            <div class="row py-lg-2">
                <div class="col-lg-12 px-0 bc_homepage seosection-bc">
                    ...
                    ?>
                    <h1><?php echo !empty($args["page_templates"]["homepage"]["seo_section"]["heading"]) ? $args["page_templates"]["homepage"]["seo_section"]["heading"] : ''; ?></h1>
                    <h2 class="pb-lg-5"><?php echo !empty($args["page_templates"]["homepage"]["seo_section"]["subheading"]) ? $args["page_templates"]["homepage"]["seo_section"]["subheading"] : ''; ?></h2>
        ...
        <div class="container pt-lg-5 py-2 bc_homepage">
            <div class="row py-lg-2">
                <div class="col-lg-12 px-0 bc_homepage seosection-bc">
                    ...
                    ?>
                    <h1><?php echo !empty($args["page_templates"]["about_us_page"]["seo_section"]["heading"]) ? $args["page_templates"]["about_us_page"]["seo_section"]["heading"] : ''; ?></h1>
                    <h2 class="pb-lg-5"><?php echo !empty($args["page_templates"]["about_us_page"]["seo_section"]["subheading"]) ? $args["page_templates"]["about_us_page"]["seo_section"]["subheading"] : ''; ?> </h2>
        ...
        <div class="container pt-lg-5 py-2 bc_homepage">
            <div class="row py-lg-2">
                <div class="col-lg-12 px-0 bc_homepage seosection-bc">
                    ...
                    ?>
                    <h1><?php echo !empty($args["page_templates"]["landing_page"]["seo_section"]["heading"]) ? $args["page_templates"]["landing_page"]["seo_section"]["heading"] : ''; ?></h1>
                    <h2 class="pb-lg-5"><?php echo !empty($args["page_templates"]["landing_page"]["seo_section"]["subheading"]) ? $args["page_templates"]["landing_page"]["seo_section"]["subheading"] : ''; ?></h2>
