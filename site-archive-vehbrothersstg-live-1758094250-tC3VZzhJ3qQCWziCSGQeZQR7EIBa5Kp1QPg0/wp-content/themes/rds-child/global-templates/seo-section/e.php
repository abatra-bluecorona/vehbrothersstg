        ...
        if ($elementorData) {
            ...
            if (isset($array_data[0]["elements"][0]["elements"][0]["settings"]["template_id"])) {
                ...
                if ($template_id == 40758) {
                    $image_placeholder_image = get_exist_image_url("seo-section", "seo-img-right");
                    $image_placeholder_image2x = get_exist_image_url("seo-section", "seo-img-right@2x");
                    $image_placeholder_image3x = get_exist_image_url("seo-section", "m-seo-img-right@3x");
        ...
        <div class="container pt-lg-5 py-2">
            <div class="row py-lg-2">
                <div class="col-lg-12 px-0 bc_homepage seosection-bc text-md-left seotext-sm-center">
                    ...
                    if ($postId == 40758) {
                    ?>
                        <img src="<?php echo get_exist_image_url("seo-section", "seo-img-right"); ?>" srcset="<?php echo get_exist_image_url("seo-section", "seo-img-right"); ?> 1x, <?php echo get_exist_image_url("seo-section", "seo-img-right@2x"); ?> 2x, <?php echo get_exist_image_url("seo-section", "seo-img-right@3x"); ?> 3x" class="img-fluid float-lg-end ms-lg-5 pb-lg-0 pb-4" width="540" height="534" alt="Homepage Image">
                    <?php
                    } else {
                    ?>
                        <img src="<?php echo get_exist_image_url("seo-section", "seo-img-right"); ?>" srcset="<?php echo get_exist_image_url("seo-section", "seo-img-right"); ?> 1x, <?php echo get_exist_image_url("seo-section", "seo-img-right@2x"); ?> 2x, <?php echo get_exist_image_url("seo-section", "seo-img-right@3x"); ?> 3x" class="img-fluid float-lg-end ms-lg-5 pb-lg-0 pb-4 d-lg-block d-none" width="540" height="534" alt="Homepage Image">
                        <img src="<?php echo get_exist_image_url("seo-section", "m-seo-img-right"); ?>" srcset="<?php echo get_exist_image_url("seo-section", "m-seo-img-right"); ?> 1x, <?php echo get_exist_image_url("seo-section", "m-seo-img-right@2x"); ?> 2x, <?php echo get_exist_image_url("seo-section", "m-seo-img-right@3x"); ?> 3x" class="img-fluid float-lg-end ms-lg-5 pb-lg-0 pb-4 d-lg-none d-block" width="350" height="278" alt="Homepage Image">
                    <?php
                    }
                    ?>
        ...
        <div class="container pt-lg-5 py-2">
            <div class="row py-lg-2">
                <div class="col-lg-12 px-0 bc_homepage seosection-bc text-md-left seotext-sm-center">
                    ...
                    ?>
                        <img src="<?php echo get_exist_image_url("seo-section", "seo-img-right"); ?>" srcset="<?php echo get_exist_image_url("seo-section", "seo-img-right"); ?> 1x, <?php echo get_exist_image_url("seo-section", "seo-img-right@2x"); ?> 2x, <?php echo get_exist_image_url("seo-section", "seo-img-right@3x"); ?> 3x" class="img-fluid float-lg-end ms-lg-5 pb-lg-0 pb-4 d-lg-block d-none" width="540" height="534" alt="Homepage Image">
                        <img src="<?php echo get_exist_image_url("seo-section", "m-seo-img-right"); ?>" srcset="<?php echo get_exist_image_url("seo-section", "m-seo-img-right"); ?> 1x, <?php echo get_exist_image_url("seo-section", "m-seo-img-right@2x"); ?> 2x, <?php echo get_exist_image_url("seo-section", "m-seo-img-right@3x"); ?> 3x" class="img-fluid float-lg-end ms-lg-5 pb-lg-0 pb-4 d-lg-none d-block h-278 w-100" width="350" height="278" alt="Homepage Image">
                    <?php
                    }
                    ?>
                    <h1 class="text-lg-start text-start text_normal text_32 sm_text_22 sm_line_height_27 line_height_37 text_normal"><?php echo !empty($args["page_templates"]["homepage"]["seo_section"]["heading"]) ? $args["page_templates"]["homepage"]["seo_section"]["heading"] : ''; ?></h1>
                    <h2 class="pb-lg-4 text-lg-start text-start text_bold text_36 line_height_41 sm_text_26 sm_line_height_31"><?php echo !empty($args["page_templates"]["homepage"]["seo_section"]["subheading"]) ? $args["page_templates"]["homepage"]["seo_section"]["subheading"] : ''; ?></h2>
                    <p class="seotext-sm-start"><?php echo !empty($args["page_templates"]["homepage"]["seo_section"]["before_read_more_content"]) ? $args["page_templates"]["homepage"]["seo_section"]["before_read_more_content"] : ''; ?></p>
