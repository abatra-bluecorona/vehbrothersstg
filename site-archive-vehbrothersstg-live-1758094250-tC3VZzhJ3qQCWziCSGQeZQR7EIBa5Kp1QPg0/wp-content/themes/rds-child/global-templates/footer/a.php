...
?>
                    ...
                    <?php if (
                        ...
                        <div class="text_16 mt-3 mt-lg-4 d-lg-flex">
                            <div class="position-relative">
                                ...
                                <div class="ps-lg-1"><span class="d-inline-block footer_add  text_normal text_14 line_height_28 pt-lg-0 pt-2 font_default ms-lg-4 ps-lg-2">
                                        <?php foreach (
                                        	$args["site_info"]["license_number"]
                                        	as $value
                                        ) {
                ...
                <div class="col-sm-12 col-lg-3 pt-lg-0 pt-3">
                    <div class="d-flex flex-column">
                        <div class="order-lg-1 order-1">
                            <h6 class="d-block mb-lg-4 mb-2 h6-alt pb-1 sm_text_16 sm_line_height_21 text-center text-lg-start">
                            ...
                            foreach ($address as $value) { ?>
                                <p class="footer_add text_14 line_height_28 font_default mb-0 text-center text-lg-start pe-xxl-5"> <?php echo $value[
                                	"address"
                                ]; ?><br> <?php echo $value[ "city" ]; ?> <?php echo $value["state"]; ?> <?php echo $value["zip"]; ?></span></p>
                            <?php }
                            }
                            ?>
                        </div>
                            ...
                            <div class="mw-266 mx-auto">
                                <div class="row">
                                    <div class="col-7 px-lg-3 px-0">
                                        <p class="footer_add text-lg-start text_14 line_height_28 mb-0 text-center">
                                    ...
                                    <div class="col-5 px-lg-3 px-0">
                                        <p class="footer_add text-lg-start text_14 line_height_28 mb-0 text-center"><?php 
    ...
    ?>
    <div class=" footer_copyright_bar text-center text-lg-start font_default mb-lg-0 mb-5 pt-1 pb-3 pt-lg-4 pb-lg-4">
        <div class="container py-lg-1 pb-3 line_height_30 font_default text_normal text_16 px-0 p-alt   ">
            ...
            echo !empty( $args["site_info"]["copyright_title"] ) ? $args["site_info"]["copyright_title"] : '';
             ...
             ) { ?><span class="d-none line_height_30  font_default  text_normal  text_16 d-md-inline-block">&nbsp; | &nbsp;</span><span class="d-block d-sm-inline-block d-lg-inline-block p-alt">Web Design by&nbsp;&nbsp;<a class=" footer_copyright_links    a-alt  copyright_hover" target="_blank" href="<?php 
             ...
             ?>
            <span class="d-lg-inline-block d-none">&nbsp; | &nbsp;</span><span class="d-lg-inline-block d-block"><a class="footer_copyright_links a-alt copyright_hover no_underline"  href="#" data-bs-toggle="modal" data-bs-target="#disclaimer">Disclaimer</a><span class="d-inline-block">&nbsp; | &nbsp;</span><a class="a-alt footer_copyright_links  copyright_hover no_underline" href="<?php echo get_home_url() .
        ...
        <div class="container p-0 color_primary_bg">
            <div class="row no-gutters">
                <div class="col-12 schedule_service text-center">
                    <a data-bs-toggle="modal" href="#" data-bs-target="#cta-a" class="py-3 d-flex align-items-center justify-content-center btn no_hover_underline mh-65" style="min-height: 65px !important;"><i  class="icon-calendar-plus3 me-2 text_18 line_height_18 "></i>Schedule Service today <i class="icon-chevron-right2 ms-2 text_18 line_height_18"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        const firstAccordionItem = jQuery('.accordion .accordion-item').first();
        const firstAccordionHeader = firstAccordionItem.find('.accordion-header h3');
        const firstAccordionIcon = firstAccordionHeader.find('i');
        firstAccordionHeader.trigger('click'); 
        firstAccordionIcon.removeClass('icon-chevron-down4').addClass('icon-chevron-up4');
