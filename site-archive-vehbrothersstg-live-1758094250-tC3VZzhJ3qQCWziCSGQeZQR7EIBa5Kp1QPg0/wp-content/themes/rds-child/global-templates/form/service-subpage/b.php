<div class="sidebar">
    <div class="shadow-xl d-lg-block d-none pt-lg-3 pb-lg-4 shadow-lg border_form border_form_light order-lg-1 order-1 color_secondary_bg ms-lg-auto max-w-348">
        <?php if (!empty($args["page_templates"]["service_subpage"]["sidebar"]["request_service"]["heading"])): ?>
            <span class="d-block pt-lg-1 p-alt text-center font_alt_1 text_normal text_26 line_height_31">
        ...
        <?php if (!empty($args["page_templates"]["service_subpage"]["sidebar"]["request_service"]["subheading"])): ?>
            <span class="d-block pb-lg-4 p-alt text-center font_alt_1 text_bold text_26 line_height_31">
