...
<div class="container-fluid pt-4 pt-lg-5 pb-lg-5 pb-4 my-2 px-lg-3 px-0">
    <div class="container subpage_full_content review_page_content pb-lg-5">
        <div class="row pb-lg-5">
            ...
            <h2 class="pb-5 text-capitalize"><?php echo !empty($args["page_templates"]["testimonial_page"]["subheading"]) ? $args["page_templates"]["testimonial_page"]["subheading"] : ''; ?></h2>
                <?php if (have_posts()): ?>
                    <?php while (have_posts()): the_post(); ?>
                      ...
                      <div class="shadow bg-white border-top-secondary p-4 text-center mb-6">
                            ...
                            <?php if (!empty($name)): ?>
                                <strong class="d-block text_16 line_height_26_4 font_alt_2"><?php echo esc_html($name); ?></strong>
                            <?php endif; ?>

                            <?php if (!empty($city)): ?>
                            <p>
                                <strong class="d-block text_16 line_height_26_4 font_alt_2">
                                    <?php 
                                    $location = '';
                                    if (!empty($city)) {
