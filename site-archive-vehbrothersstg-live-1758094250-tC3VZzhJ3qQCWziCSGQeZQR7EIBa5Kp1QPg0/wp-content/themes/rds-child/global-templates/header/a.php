            ...
            <div class="col-lg-9 ps-0 text-end pt-3">
                <div class="d-lg-flex align-items-center justify-content-end font_default mt-2 pt-2">
                    <span class="px-2 py-2 me-2 mb-0 call_today">
                        <?php echo !empty($args["globals"]["header"]["call_text"]) ? $args["globals"]["header"]["call_text"] : '';
//echo $args["globals"]["header"]["call_text"];
?> <a href="tel: <?php
...
?>" class=" phone_number">
                    ...
                    <?php if (!empty($args["globals"]["desktop_schedule_online_button"]["enabled"])) {
                        if ($args["globals"]["desktop_schedule_online_button"]["type"] != "url") { ?>
                            <span id="schedule_online_button_desktop" class="btn btn-primary mw-242 mh-43 " ><i class="<?php echo !empty($args["globals"]["desktop_schedule_online_button"]["icon_class"])
                                ? $args["globals"]["desktop_schedule_online_button"]["icon_class"]
                                : '';
                            //echo $args["globals"]["desktop_schedule_online_button"]["icon_class"];
                            ?>"></i><?php echo !empty($args["globals"]["desktop_schedule_online_button"]["label"]) ? $args["globals"]["desktop_schedule_online_button"]["label"] : '';
                            // echo $args["globals"]["desktop_schedule_online_button"]["label"];
                            ?></span>
                        <?php } else { ?>
                            <a  class="btn btn-primary mw-242 mh-43 "  href="<?php echo get_home_url() .
                                (!empty($args["globals"]["desktop_schedule_online_button"]["url"]) ? $args["globals"]["desktop_schedule_online_button"]["url"] : ''); ?>"><i class="<?php echo !empty(
    $args["globals"]["desktop_schedule_online_button"]["icon_class"]
)
    ? $args["globals"]["desktop_schedule_online_button"]["icon_class"]
    : ''; ?>"></i><?php echo !empty($args["globals"]["desktop_schedule_online_button"]["label"]) ? $args["globals"]["desktop_schedule_online_button"]["label"] : ''; ?></a>
                            <?php }
                    } ?>                       
                </div>
        ...
        <div class="row row-eq-height no-gutters align-items-center">
            ...
            <div class="col-7 text-center px-0">
                <a href="<?php echo get_home_url(); ?>" class="d-block">
                    <img src="<?php echo get_exist_image_url("header", "m-header-logo"); ?>" srcset="<?php echo get_exist_image_url("header", "m-header-logo"); ?> 1x, <?php echo get_exist_image_url(
     "header",
     "m-header-logo@2x"
 ); ?> 2x, <?php echo get_exist_image_url("header", "m-header-logo@3x"); ?> 3x"  width="200" height="40" style="max-width: 200px" class="img-fluid w-atuo" <?php echo $header_mobile_logo_alt; ?> >
                </a>
            </div>
            <div class="col-3 text-center pe-0">
                <div class="d-flex h-100 phone-icon no_hover_underline ">
                    <a data-bs-toggle="modal" href="#" data-bs-target="#cta-a"  class="d-flex align-items-center justify-content-center w-100 no_hover_underline color_primary_bg">
                        <i class="color_tertiary icon-phone-flip  text_24 line_height_24  "></i>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog mt-0" role="document">
        <div class="modal-content border-0 position-absolute mt-md-0">
            ...
            <div class="modal-body px-2 mobile_popup_form_background_color text-center border-0">
                <img src="<?php echo get_exist_image_url("header", "m-menu-cta-logo@3x"); ?>" srcset="<?php echo get_exist_image_url("header", "m-menu-cta-logo"); ?> 1x, <?php echo get_exist_image_url(
     "header",
     "m-menu-cta-logo@2x"
 ); ?> 2x, <?php echo get_exist_image_url("header", "m-menu-cta-logo@3x"); ?> 3x"  class="mb-4 w-auto h-auto" <?php echo $header_mobile_cta_alt; ?> width="191" height="39"> 
                <div class="text-center">
                    ...
                    <?php if (!empty($args["globals"]["ctas"])) {
