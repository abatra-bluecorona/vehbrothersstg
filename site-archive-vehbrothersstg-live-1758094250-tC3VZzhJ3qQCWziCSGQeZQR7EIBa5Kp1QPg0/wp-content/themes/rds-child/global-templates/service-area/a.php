                    ...
                    <div class="d-block pe-xl-4 pt-sm-0 pt-5 mw-sm-320 mx-sm-0 mx-auto">
                        ...
                        if (!empty($heading)) {
                            if ($heading != strip_tags($heading)) {
                                // is HTML
                                echo '<span class="h5-alt pt-sm-0 pt-4 mb-sm-2 mb-0 sm_text_bold">'.$heading.'</span>';
                            } else {
                                // not HTML
                                echo '<h5 class="h5-alt pt-sm-0 pt-4 mb-sm-2 mb-0 sm_text_bold">'.$heading.'</h5>';
                            }
                        }
                        ...
                        if (!empty($subheading)) {
                            if ($subheading != strip_tags($subheading)) {
                                // is HTML
                                echo '<div class="border-bottom-tertiary h4-alt pb-2 sm_text_semibold">'.$subheading.'</div>';
                            } else {
                                // not HTML
                                echo '<h4 class="border-bottom-tertiary h4-alt pb-2 sm_text_semibold">'.$subheading.'</h4>';
                            }
                        }
