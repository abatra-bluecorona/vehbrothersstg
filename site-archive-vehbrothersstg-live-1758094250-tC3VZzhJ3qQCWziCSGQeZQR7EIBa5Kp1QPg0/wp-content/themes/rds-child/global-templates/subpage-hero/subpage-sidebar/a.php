    ...
    <div class="container px-0 py-lg-3 pb-4">
        <div class="row">
            <div class="col-lg-12 py-3 py-lg-4"> 
				...
				if ($i == 0) {
					if (!empty($args['page_templates']['subpage']['sidebar']['banner']['heading'])) {
						?>
						<span class="d-block display1"><?php echo esc_html($args['page_templates']['subpage']['sidebar']['banner']['heading']); ?> </span> 
						<?php
					}
					if (!empty($args['page_templates']['subpage']['sidebar']['banner']['subheading'])) {
						?>
						<span class="d-block display2"><?php echo esc_html($args['page_templates']['subpage']['sidebar']['banner']['subheading']); ?> </span>
						<?php
					}
					if (!empty($args['page_templates']['subpage']['sidebar']['banner']['button_text']) && !empty($args['page_templates']['subpage']['sidebar']['banner']['button_link'])) {
						?>
						<a href="<?php echo esc_url(get_home_url() . $args['page_templates']['subpage']['sidebar']['banner']['button_link']); ?>" class="btn btn-primary mw-237 mt-3"><?php echo esc_html($args['page_templates']['subpage']['sidebar']['banner']['button_text']); ?>  <i class="icon-chevron-right1 ms-1 text_18 line_height_18 d-lg-inline-block"></i></a> 
						<?php 
					}
				}
