...
<?php
    ...
    $display = ""; // Initialize $display variable

    if (strpos($url, "coupon") || strpos($url, "careers") || strpos($url, "mobile-popup")) {
        $display = "d-none";
    } else {
      $display = "d-block";
    }
            ...
            <div class="row pb-lg-2 pt-lg-5 mx-0">
                <div class="col-12 col-lg-12 order-lg-1 order-1 pt-lg-1">
                    <div class="text-center">
                        ...
                        ?>
                        <h1 class="mt-4 pt-2 thankyou_page_heading_color"><?php the_title(); ?></h1>
                        <p class="thankyou_page_content_color">
                        ...
                        if ($temName != "rds-coupon-thankyou.php") {
                            ?>
                            <div class="text-center pt-2 <?php echo $display; ?>">
                                <span onclick="scrollSmoothTo('thankyou_page_promotion')" class="next-service btn btn-primary mw-351" id="bc-thankyou"><?php echo !empty($args["page_templates"]["thankyou_page"]["scroll_button_text"]) ? esc_html($args["page_templates"]["thankyou_page"]["scroll_button_text"]) : ''; ?> <i class="icon-circle-arrow-down2 ms-2 line_height_18"></i></span>
                            </div>
                            <?php
                        }
                        ?>
...
<div class="d-block order-2 order-lg-2" id="next-service">
    <div class="container-fluid bg-light bc-thnkyu-trust px-0">
        <div class="container">
            <div class="row">
...
<?php if (!empty($args["page_templates"]["thankyou_page"]["show_promotions"]) && $args["page_templates"]["thankyou_page"]["show_promotions"] == 1) { ?>
    <div class="<?php echo $display; ?> d-block order-3 order-lg-3" id="thankyou_page_promotion">
            ...
            <div class="container px-lg-3 pb-lg-5">
                <div class="row align-items-center">
                    <div class="col-lg-6 px-4 px-lg-3 text-center text-lg-start mb-5 mb-lg-0">
                        ...
                        <a href="<?php echo esc_url(get_home_url() . (!empty($args["page_templates"]["thankyou_page"]["promotions"]["button_link"]) ? $args["page_templates"]["thankyou_page"]["promotions"]["button_link"] : '#')); ?>" class="btn btn-primary mw-278">
...
<div class="modal fade request_form px-lg-0 px-0 pt-5 pt-md-0" id="thank_you_request_coupon_form" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="requestcoupon_Label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered px-lg-0 px-2" role="document">
            ...
            <div class="modal-body p-lg-4 p-2 w-100 my-auto mx-auto coupons">
                <div class="border-dashed-7 pt-lg-4 pb-lg-4 py-4 footer_form_A ui_kit_footer_form elementor-popupform">
                    ...
                    <div class="my-md-0 mt-lg-4 mt-3 w-lg-260 mx-auto text-start text-lg-center d-flex align-items-center justify-content-center pb-4 px-lg-0 px-4">
                        ...
                        <span class="font_default text_bold text_16 line_height_25 sm_text_16  sm_line_height_30 "><?php echo !empty($args["globals"]["promotion"]["popup_form_subheading"]) ? esc_html($args["globals"]["promotion"]["popup_form_subheading"]) : ''; ?></span>
                    </div>
        ...
        function couponButtonThankyouClick(attr) {
